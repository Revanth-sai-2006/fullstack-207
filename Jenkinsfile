pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://54.89.234.218:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/Revanth-sai-2006/fullstack-207.git', branch: 'master'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://54.89.234.218:9090/springapp1"
            echo "✅ Frontend deployed: http://54.89.234.218:9090/frontapp1"
        }
        failure {
